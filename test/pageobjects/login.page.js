...
class LoginPage extends Page {
    ...
    get PasswordError () { return $('//h3[text()="Epic sadface: Username and password do not match any user in this service"]') }
    ...
    async validatePasswordError () {
      await this.PasswordError.waitForDisplayed({ timeout: 2500 });
      await expect(this.PasswordError).toBeDisplayed()
  }
